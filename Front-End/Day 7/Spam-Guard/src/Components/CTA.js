...
const Analytics = () => {
  return (
    <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8" id='spam-free'>
      <div className="relative isolate overflow-hidden bg-gray-100 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
        ...
        <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          ...
          Get Started Today for a Spam-Free Tomorrow
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-700">
          Ready to reclaim your inbox? Take the first step towards a spam-free email experience. Our user-friendly platform is designed to get you up and running in no time.
          </p>
